# Figures For Overleaf Draft v0.9

This folder contains the figure assets bundled with the report/preprint-oriented portable Overleaf draft. Draft v0.9 retains the LaTeX-native TikZ methodology workflow figure.
