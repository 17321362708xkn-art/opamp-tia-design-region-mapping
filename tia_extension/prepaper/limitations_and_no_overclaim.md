...
- SPICE macromodels are vendor-provided simulation models, not experimental hardware results.
- The MATLAB op-amp model is a simplified single-pole finite-A0 / finite-GBW representation.
- The behavioural noise model is first-pass only and uses configured density assumptions rather than measured detector data.
- Safe, Marginal, and Risky thresholds are project-defined design-screening labels, not universal stability guarantees.
