...
- Evidence: baseline response figures, `Cf` bandwidth and peaking sweeps, design-region maps, OP27 LTspice smoke-test comparison, and OPA818 vendor macromodel Cf sweep.
- Noise: first-pass behavioural noise contribution and noise-bandwidth trade-off estimates.
- Limitation: no hardware measurement, no experimental noise evidence, and at least one additional vendor SPICE macromodel still required.
...
- Summarize real OP27 LTspice smoke-test comparison and OPA818 vendor macromodel Cf sweep as limited SPICE macromodel evidence.
