# Generic Overleaf Draft v0.2

This folder is a cleaned generic Overleaf/LaTeX draft converted from `tia_extension/prepaper/manuscript_draft_v0_4_audit_fixed.md`.
