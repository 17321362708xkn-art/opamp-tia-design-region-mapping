# Workflow-Focused Overleaf Draft v0.6

This folder is a workflow-focused Overleaf/LaTeX draft copied from `tia_extension/overleaf_draft_v0_5/` and updated with the Round 28 small-Cf breakdown framing and Cin ablation evidence.
...
- Figure 6 is the behavioural-vs-vendor agreement error summary.
