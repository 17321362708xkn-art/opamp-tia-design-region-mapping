# Figures For Overleaf Draft v0.6

This folder contains the PNG figure assets bundled with the workflow-focused portable Overleaf draft. Draft v0.6 adds Round 28 small-Cf boundary overlays copied into this local figure folder for Overleaf portability.
