# Figures For Overleaf Draft v0.7

This folder contains the figure assets bundled with the workflow-focused portable Overleaf draft. Draft v0.7 adds a LaTeX-native TikZ methodology workflow figure.
