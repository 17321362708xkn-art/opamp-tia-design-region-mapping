...
This work presents a MATLAB- and vendor-macromodel-assisted workflow for early-stage photodiode TIA design screening under finite op-amp bandwidth constraints. The workflow combines a simplified MATLAB behavioural model, feedback-capacitance sweeps, project-defined design-region maps, vendor macromodel comparison for OP27, OPA818, and ADA4817, and first-pass behavioural noise estimates. The evidence is traceable through repository scripts, CSV files, figures, and manuscript-preparation notes.
